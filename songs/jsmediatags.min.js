...
b){for(var c=-1,a=-1,d=0,k=0;k<this._fileData.length;k++,d=k){var h=this._fileData[k].offset,r=h+this._fileData[k].data.length;if(b<h-1)break;if(e<=r+1&&b>=h-1){c=k;break}}if(-1===c)return{startIx:-1,endIx:-1,insertIx:d};for(k=c;k<this._fileData.length&&!(h=this._fileData[k].offset,r=h+this._fileData[k].data.length,b>=h-1&&(a=k),b<=r+1);k++);-1===a&&(a=c);return{startIx:c,endIx:a}}},{key:"hasDataRange",value:function(e,b){for(var c=0;c<this._fileData.length;c++){var a=this._fileData[c];if(b<a.offset)break;
...
}e(b,null,[{key:"getFrameReaderFunction",value:function(a){return a in d?d[a]:"T"===a[0]?d["T*"]:"W"===a[0]?d["W*"]:null}},{key:"readFrames",value:function(a,d,c,k,e){for(var l={};a<d;){var f=this._readFrameHeader(c,a,k),t=f.id;if(!t)break;var m=f.flags,g=f.size,n=a+f.headerSize,q=c;a+=f.headerSize+f.size;e&&-1===e.indexOf(t)||(m&&m.format.unsynchronisation&&(q=this.getUnsyncFileReader(q,n,g),n=0,g=q.getSize()),m&&m.format.data_length_indicator&&(n+=4,g-=4),m=(f=b.getFrameReaderFunction(t))?f.apply(this,
[n,g,q,m,k]):null,n=this._getFrameDescription(t),g={id:t,size:g,description:n,data:m},t in l?(l[t].id&&(l[t]=[l[t]]),l[t].push(g)):l[t]=g)}return l}},{key:"_readFrameHeader",value:function(a,d,b){b=b.major;var h=null;switch(b){case 2:var c=a.getStringAt(d,3),k=a.getInteger24At(d+3,!0),e=6;break;case 3:c=a.getStringAt(d,4);k=a.getLongAt(d+4,!0);e=10;break;case 4:c=a.getStringAt(d,4),k=a.getSynchsafeInteger32At(d+4),e=10}if(c==String.fromCharCode(0,0,0)||c==String.fromCharCode(0,0,0,0))c="";c&&2<b&&
(h=this._readFrameFlags(a,d+8));return{id:c||"",size:k||0,headerSize:e||0,flags:h}}},{key:"_readFrameFlags",value:function(a,d){return{message:{tag_alter_preservation:a.isBitSetAt(d,6),file_alter_preservation:a.isBitSetAt(d,5),read_only:a.isBitSetAt(d,4)},format:{grouping_identity:a.isBitSetAt(d+1,7),compression:a.isBitSetAt(d+1,3),encryption:a.isBitSetAt(d+1,2),unsynchronisation:a.isBitSetAt(d+1,1),data_length_indicator:a.isBitSetAt(d+1,0)}}}},{key:"_getFrameDescription",value:function(d){return d in
a?a[d]:"Unknown"}},{key:"getUnsyncFileReader",value:function(a,d,b){a=a.getBytesAt(d,b);for(d=0;d<a.length-1;d++)255===a[d]&&0===a[d+1]&&a.splice(d+1,1);return new c(a)}}]);return b}();var d={APIC:function(a,d,b,c,e){c=a;var p=g(b.getByteAt(a));switch(e&&e.major){case 2:e=b.getStringAt(a+1,3);a+=4;break;case 3:case 4:e=b.getStringWithCharsetAt(a+1,d-1);a+=1+e.bytesReadCount;break;default:throw Error("Couldn't read ID3v2 major version.");}var l=b.getByteAt(a,1),l=k[l],p=b.getStringWithCharsetAt(a+
1,d-(a-c)-1,p);a+=1+p.bytesReadCount;return{format:e.toString(),type:l,description:p.toString(),data:b.getBytesAt(a,c+d-a)}},CHAP:function(a,d,c,k,e){k=a;var p={},l=b.readNullTerminatedString(c.getBytesAt(a,d));p.id=l.toString();a+=l.bytesReadCount;p.startTime=c.getLongAt(a,!0);a+=4;p.endTime=c.getLongAt(a,!0);a+=4;p.startOffset=c.getLongAt(a,!0);a+=4;p.endOffset=c.getLongAt(a,!0);a+=4;p.subFrames=this.readFrames(a,a+(d-(a-k)),c,e);return p},CTOC:function(a,d,c,k,e){k=a;var p={childElementIds:[]},
l=b.readNullTerminatedString(c.getBytesAt(a,d));p.id=l.toString();a+=l.bytesReadCount;p.topLevel=c.isBitSetAt(a,1);p.ordered=c.isBitSetAt(a,0);a++;p.entryCount=c.getByteAt(a);a++;for(l=0;l<p.entryCount;l++){var f=b.readNullTerminatedString(c.getBytesAt(a,d));p.childElementIds.push(f.toString());a+=f.bytesReadCount}p.subFrames=this.readFrames(a,a+(d-(a-k)),c,e);return p},COMM:function(a,d,b,c,k){var e=a,l=g(b.getByteAt(a));c=b.getStringAt(a+1,3);k=b.getStringWithCharsetAt(a+4,d-4,l);a+=4+k.bytesReadCount;
a=b.getStringWithCharsetAt(a,e+d-a,l);return{language:c,short_description:k.toString(),text:a.toString()}}};d.COM=d.COMM;d.PIC=function(a,b,c,k,e){return d.APIC(a,b,c,k,e)};d.PCNT=function(a,d,b,c,k){return b.getLongAt(a,!1)};d.CNT=d.PCNT;d["T*"]=function(a,d,b,c,k){c=g(b.getByteAt(a));return b.getStringWithCharsetAt(a+1,d-1,c).toString()};d.TXXX=function(a,d,b,c,k){c=g(b.getByteAt(a));return m(a,d,b,c)};d["W*"]=function(a,d,b,c,k){c=g(b.getByteAt(a));return void 0!==c?m(a,d,b,c):b.getStringWithCharsetAt(a,
d,c).toString()};d.TCON=function(a,b,c,k){return d["T*"].apply(this,arguments).replace(/^\(\d+\)/,"")};d.TCO=d.TCON;d.USLT=function(a,d,b,c,k){var e=a,l=g(b.getByteAt(a));c=b.getStringAt(a+1,3);k=b.getStringWithCharsetAt(a+4,d-4,l);a+=4+k.bytesReadCount;a=b.getStringWithCharsetAt(a,e+d-a,l);return{language:c,descriptor:k.toString(),lyrics:a.toString()}};d.ULT=d.USLT;var k="Other;32x32 pixels 'file icon' (PNG only);Other file icon;Cover (front);Cover (back);Leaflet page;Media (e.g. label side of CD);Lead artist/lead performer/soloist;Artist/performer;Conductor;Band/Orchestra;Composer;Lyricist/text writer;Recording Location;During recording;During performance;Movie/video screen capture;A bright coloured fish;Illustration;Band/artist logotype;Publisher/Studio logotype".split(";");
...
f+"."+g,major:f,revision:g,flags:{unsynchronisation:m,extended_header:u,experimental_indicator:p,footer_present:!1},size:l,tags:{}};if(c)var t=this._expandShortcutTags(c);g=l+10;f.flags.unsynchronisation&&(a=e.getUnsyncFileReader(a,h,l),h=0,g=a.getSize());var h=e.readFrames(h,g,a,f,t),q;for(q in b)b.hasOwnProperty(q)&&(l=this._getFrameData(h,b[q]))&&(f.tags[q]=l);for(var y in h)h.hasOwnProperty(y)&&(f.tags[y]=h[y]);return f}},{key:"_getFrameData",value:function(a,b){for(var c=0,e;e=b[c];c++)if(e in
...
(e.writable=!0);Object.defineProperty(b,e.key,e)}}return function(b,c,d){c&&a(b.prototype,c);d&&a(b,d);return b}}();f("./MediaFileReader");q=f("./NodeFileReader");var b=f("./XhrFileReader"),c=f("./BlobFileReader"),a=f("./ArrayFileReader");f("./MediaTagReader");var d=f("./ID3v1TagReader"),k=f("./ID3v2TagReader");f=f("./MP4TagReader");var h=[],r=[],w=function(){function a(b){g(this,a);this._file=b}e(a,[{key:"setTagsToRead",value:function(a){this._tagsToRead=a;return this}},{key:"setFileReader",value:function(a){this._fileReader=
...
throw Error("No suitable file reader found for ",this._file);}},{key:"_getTagReader",value:function(a,b){if(this._tagReader){var c=this._tagReader;setTimeout(function(){b.onSuccess(c)},1)}else this._findTagReader(a,b)}},{key:"_findTagReader",value:function(a,b){for(var c=[],d=[],e=a.getSize(),f=0;f<r.length;f++){var g=r[f].getTagIdentifierByteRange();m(g,e)&&(0<=g.offset&&g.offset<e/2||0>g.offset&&g.offset<-e/2?c.push(r[f]):d.push(r[f]))}var h=!1,f={onSuccess:function(){if(h){for(var c=0;c<r.length;c++){var d=
r[c].getTagIdentifierByteRange();if(m(d,e)){try{var f=a.getBytesAt(0<=d.offset?d.offset:d.offset+e,d.length)}catch(g){if(b.onError){b.onError({type:"fileReader",info:g.message});return}}if(r[c].canReadTagFormat(f)){b.onSuccess(r[c]);return}}}if(b.onError)b.onError({type:"tagFormat",info:"No suitable tag reader found"})}else h=!0},onError:b.onError};this._loadTagIdentifierRanges(a,c,f);this._loadTagIdentifierRanges(a,d,f)}},{key:"_loadTagIdentifierRanges",value:function(a,b,c){if(0===b.length)setTimeout(c.onSuccess,
1);else{for(var d=[Number.MAX_VALUE,0],e=a.getSize(),f=0;f<b.length;f++){var g=b[f].getTagIdentifierByteRange(),h=0<=g.offset?g.offset:g.offset+e,g=h+g.length-1;d[0]=Math.min(h,d[0]);d[1]=Math.max(g,d[1])}a.loadRange(d,c)}}}]);return a}(),v=function(){function a(){g(this,a)}e(a,null,[{key:"addFileReader",value:function(b){h.push(b);return a}},{key:"addTagReader",value:function(b){r.push(b);return a}},{key:"removeTagReader",value:function(b){b=r.indexOf(b);0<=b&&r.splice(b,1);return a}},{key:"EXPERIMENTAL_avoidHeadRequests",
